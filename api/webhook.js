...
const normalWords = [
    ...
    // 追加の単語
    { english: "activity", japanese: "活動" }, { english: "afraid", japanese: "恐れて" },
    { english: "agree", japanese: "同意する" }, { english: "allow", japanese: "許す" },
    { english: "arrive", japanese: "到着する" }, { english: "attend", japanese: "出席する" },
    { english: "attention", japanese: "注意" }, { english: "avoid", japanese: "避ける" },
    { english: "beautiful", japanese: "美しい" }, { english: "become", japanese: "〜になる" },
    { english: "borrow", japanese: "借りる" }, { english: "brave", japanese: "勇敢な" },
    { english: "bright", japanese: "明るい" }, { english: "business", japanese: "仕事、ビジネス" },
    { english: "careful", japanese: "注意深い" }, { english: "change", japanese: "変える、変化" },
    { english: "cheap", japanese: "安い" }, { english: "choose", japanese: "選ぶ" },
    { english: "common", japanese: "共通の、普通の" }, { english: "compare", japanese: "比較する" },
    { english: "continue", japanese: "続ける" }, { english: "culture", japanese: "文化" },
    { english: "customer", japanese: "顧客" }, { english: "danger", japanese: "危険" },
    { english: "depend", japanese: "頼る" }, { english: "describe", japanese: "説明する" },
    { english: "different", japanese: "異なる" }, { english: "difficult", japanese: "難しい" },
    ...
    { english: "hobby", japanese: "趣味" }, { english: "however", japanese: "しかしながら" },
    { english: "include", japanese: "含む" }, { english: "increase", japanese: "増加する" },
    { english: "influence", japanese: "影響" }, { english: "information", japanese: "情報" },
    { english: "interest", japanese: "興味" }, { english: "invite", japanese: "招待する" },
    { english: "island", japanese: "島" }, { english: "join", japanese: "参加する" },
    { english: "kind", japanese: "種類、親切な" }, { english: "level", japanese: "レベル、水準" },
    { english: "local", japanese: "地元の" }, { english: "lose", japanese: "失う" },
    { english: "machine", japanese: "機械" }, { english: "matter", japanese: "問題、重要である" },
    { english: "memory", japanese: "記憶" }, { english: "million", japanese: "百万" },
    { english: "minute", japanese: "分" }, { english: "moment", japanese: "瞬間" },
    { english: "mountain", japanese: "山" }, { english: "necessary", japanese: "必要な" },
    ...
    { english: "prepare", japanese: "準備する" }, { english: "present", japanese: "贈り物、現在" },
    { english: "president", japanese: "大統領、社長" }, { english: "price", japanese: "価格" },
    { english: "problem", japanese: "問題" }, { english: "produce", japanese: "生産する" },
    { english: "promise", japanese: "約束" }, { english: "provide", japanese: "提供する" },
    { english: "purpose", japanese: "目的" }, { english: "question", japanese: "質問" },
    { english: "reach", japanese: "到着する" }, { english: "reason", japanese: "理由" },
    { english: "remember", japanese: "思い出す" }, { english: "report", japanese: "報告する" },
    { english: "result", japanese: "結果" }, { english: "return", japanese: "戻る" },
    ...
    { english: "several", japanese: "いくつかの" }, { english: "share", japanese: "共有する" },
    { english: "similar", japanese: "似ている" }, { english: "simple", japanese: "簡単な" },
    ...
    { english: "straight", japanese: "まっすぐな" }, { english: "strange", japanese: "奇妙な" },
    { english: "street", japanese: "通り" }, { english: "strong", japanese: "強い" },
    { english: "success", japanese: "成功" }, { english: "support", japanese: "支援する" },
    { english: "surprise", japanese: "驚き" }, { english: "system", japanese: "システム" },
    { english: "talent", japanese: "才能" }, { english: "though", japanese: "〜だけれども" },
    { english: "thought", japanese: "考え" }, { english: "ticket", japanese: "切符" },
    ...
    { english: "trouble", japanese: "問題" }, { english: "useful", japanese: "役立つ" },
    { english: "usual", japanese: "いつもの" }, { english: "vacation", japanese: "休暇" },
    { english: "village", japanese: "村" }, { english: "visit", japanese: "訪れる" },
    { english: "voice", japanese: "声" }, { english: "welcome", japanese: "歓迎する" },
    { english: "whole", japanese: "全体の" }, { english: "without", japanese: "〜なしで" },
